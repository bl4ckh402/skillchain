...
export default function InstructorAvailabilityPage() {
      ...
      for (let hour = 9; hour < 17; hour++) {
        for (let minute = 0; minute < 60; minute += 30) {
          ...
          const endTime = `${endHour
            .toString()
            .padStart(2, "0")}:${normalizedEndMinute
            .toString()
            .padStart(2, "0")}`;
  ...
  const addSessionDuration = (duration: string) => {
    ...
    const newDurations = [...settings.sessionDurations, duration].sort(
      (a, b) => {
  ...
  const removeSessionDuration = (duration: string) => {
    ...
    const newDurations = settings.sessionDurations.filter(
      (d) => d !== duration
    );
    const newPricing = { ...settings.pricing };
  ...
  return (
    <div className="flex flex-col min-h-screen">
      <main className="flex-1">
        <div className="py-8 bg-gradient-to-r from-green-500/10 to-teal-500/10 dark:from-green-900/20 dark:to-teal-900/20">
          <div className="container px-4 md:px-6">
            <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
              ...
              <Button
                className="text-white bg-gradient-to-r from-green-600 to-teal-600 hover:from-green-700 hover:to-teal-700"
        ...
        <div className="container py-8">
          {error && (
            <div className="p-4 mb-6 text-red-700 border border-red-200 rounded-lg bg-red-50 dark:bg-red-900/30 dark:border-red-800 dark:text-red-400">
              ...
              <Button
                variant="link"
                className="h-auto p-0 mt-1 text-red-700 dark:text-red-400"
          ...
          {loading ? (
            <div className="flex items-center justify-center p-12 border border-dashed rounded-lg border-slate-200 dark:border-slate-800">
            ...
            <Tabs defaultValue="schedule" className="space-y-6">
              <TabsList className="p-1 rounded-lg bg-slate-100 dark:bg-slate-800/50">
                <TabsTrigger
                  value="schedule"
                  className="data-[state=active]:bg-white dark:data-[state=active]:bg-slate-950 data-[state=active]:text-green-600 rounded-md"
                >
                    ...
                    <div className="grid grid-cols-1 gap-4 md:grid-cols-7">
                      {DAYS.map((day, dayIndex) => (
                        <div key={day} className="space-y-2">
                          <h3 className="font-medium text-center text-slate-800 dark:text-slate-200">
                            {day}
                          </h3>
                          <div className="p-2 space-y-1 rounded-lg bg-slate-50 dark:bg-slate-900">
                            {TIMES.map((time, timeIndex) => {
                              ...
                              const slot = settings.slots.find(
                                (s) =>
                                  s.day === dayIndex && s.startTime === time
                              );
              ...
              <TabsContent value="preferences" className="space-y-6">
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Configure your session durations, pricing, and booking
                      preferences.
                    </CardDescription>
                  </CardHeader>
                        ...
                        {settings.sessionDurations.map((duration) => (
                          ...
                          >
                            ...
                            <div className="flex items-center flex-1 gap-2">
                              <span className="text-slate-500 dark:text-slate-400 min-w-[30px]">
                                $
                              </span>
                              <Input
                                type="number"
                          ...
                          >
                            ...
                            <SelectContent>
                              {[
                                ...
                                .filter(
                                  (d) => !settings.sessionDurations.includes(d)
                                )
                                .map((duration) => (
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                        <div className="space-y-2">
                          ...
                          <Input
                            ...
                            onChange={(e) =>
                              handleBufferTimeChange(e.target.value)
                            }
                            min="0"
                          />
                        ...
                        <div className="space-y-2">
                          ...
                          <Input
                            ...
                            onChange={(e) =>
                              handleAdvanceBookingDaysChange(e.target.value)
                            }
                            min="1"
                          />
                          <p className="text-xs text-slate-500 dark:text-slate-400">
                      ...
                      <div className="flex items-center justify-between pt-2">
                        <div className="space-y-0.5">
                          ...
                          <p className="text-xs text-slate-500 dark:text-slate-400">
                            Automatically accept booking requests that match
                            your availability
                          </p>
                        </div>
                        <Switch
