        ...
        <div className="container px-4 py-16 md:px-6">
          <div className="flex flex-col items-center space-y-4 text-center">
            ...
            <p className="max-w-[700px] text-slate-100 md:text-xl dark:text-slate-100">
              Join our live, instructor-led bootcamps to accelerate your career
              in tech. Learn from industry experts and build real-world
              projects.
            </p>
          </div>
        </div>
            ...
            <div className="space-y-2">
              ...
              >
                ...
                <SelectContent>
                  ...
                  <SelectItem value={BootcampStatus.UPCOMING}>
                    Upcoming
                  </SelectItem>
                  <SelectItem value={BootcampStatus.IN_PROGRESS}>
                    In Progress
                  </SelectItem>
                  <SelectItem value={BootcampStatus.COMPLETED}>
                    Completed
                  </SelectItem>
                </SelectContent>
              </Select>
