    ...
    const fetchFirstCourse = async () => {
      try {
        ...
        toast({
          title: "Error",
          description:
            "Failed to load eligibility information. Please refresh the page.",
          variant: "destructive",
        });
      } finally {
            ...
            {step === 1 && (
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Before applying, please ensure you meet our basic
                    requirements
                  </CardDescription>
                </CardHeader>
                <CardContent className="space-y-6">
                  <Alert className="bg-amber-50 text-amber-800 border-amber-200 dark:bg-amber-900/30 dark:text-amber-300 dark:border-amber-800">
                    ...
                    <AlertDescription>
                      To become an instructor, you must have completed our
                      foundational course: {requiredCourse.title}
                    </AlertDescription>
                  </Alert>
                  ...
                  <div className="space-y-4">
                    ...
                    {isLoadingCourse ? (
                      <div className="flex items-center justify-center p-8">
                        <Loader2 className="w-8 h-8 mr-2 text-blue-500 animate-spin" />
                        ...
                        <div className="flex flex-col sm:flex-row">
                          ...
                          <div className="flex-1 p-4">
                            ...
                            {!eligibilityChecked ? (
                              ...
                              <Alert className="text-green-800 border-green-200 bg-green-50 dark:bg-green-900/30 dark:text-green-300 dark:border-green-800">
                                <CheckCircle2 className="w-4 h-4" />
                                <AlertTitle>Eligible!</AlertTitle>
                                <AlertDescription>
                                  You've completed the required course and are
                                  eligible to apply.
                                </AlertDescription>
                              </Alert>
                            ) : (
                              <Alert className="text-red-800 border-red-200 bg-red-50 dark:bg-red-900/30 dark:text-red-300 dark:border-red-800">
                                <X className="w-4 h-4" />
                                <AlertTitle>Not Eligible</AlertTitle>
                                <AlertDescription>
                                  You need to complete the{" "}
                                  {requiredCourse.title} course before applying.
                                  <div className="mt-2">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex items-start gap-2">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground">
                            You should be willing to create high-quality,
                            up-to-date content
                          </p>
                        </div>
                      </div>
                      <div className="flex items-start gap-2">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground">
                            You should be able to respond to student questions
                            and update course materials
                          </p>
                        </div>
                      </div>
                    </div>
            ...
            {step === 2 && (
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Tell us about your expertise and what you'd like to teach
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <Tabs defaultValue="personal" className="w-full">
                    ...
                    <TabsContent value="teaching" className="pt-4 space-y-4">
                      <div className="space-y-2">
                      ...
                      <div className="space-y-2">
                        ...
                        <RadioGroup
                          ...
                          onValueChange={(value) =>
                            handleRadioChange("timeCommitment", value)
                          }
                        >
                          <div className="flex items-center space-x-2">
                    ...
                    <div>
                      ...
                      <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                        ...
                        <div>
                          ...
                          <p className="font-medium">
                            {formData.linkedinProfile || "Not provided"}
                          </p>
                        </div>
                        <div>
                          <p className="text-sm text-muted-foreground">
                          ...
                          <p className="font-medium">
                            {formData.githubProfile || "Not provided"}
                          </p>
                        </div>
                        <div>
                          <p className="text-sm text-muted-foreground">
                          ...
                          <p className="font-medium">
                            {formData.portfolioUrl || "Not provided"}
                          </p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <div className="space-y-3">
                        ...
                        <div>
                          ...
                          <p className="font-medium">
                            {formData.courseIdeas || "Not provided"}
                          </p>
                        </div>
                        <div>
                          <p className="text-sm text-muted-foreground">
