                      ...
                      return (
                        <div key={section.title} className="my-2">
                          <Link
                            ...
                            onClick={() => setIsOpen(false)}
                            className={cn(
                              "flex items-center gap-2 px-4 py-2 rounded-full font-semibold bg-green-400/90 text-black shadow-lg hover:bg-green-300 border-2 border-green-500 transition-all duration-200",
                              sectionActive && "ring-2 ring-green-500"
                            )}
                          ...
                          >
                            ...
                            <span className="truncate">{section.title}</span>
                            <span className="ml-2 px-2 py-0.5 rounded-full bg-green-500 text-xs font-bold text-white">
                              HOT
                            </span>
                          </Link>
                        </div>
